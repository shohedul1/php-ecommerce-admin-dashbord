...
<div class="container mt-3">
    ...
    <form action="" method='post' class="text-center">
        <div class="form-outline mb-4  w-50 m-auto">
            ...
            <input type="text" name="brand_title" class="form-control" id="brand_title" required="required" value="<?php echo $brand_title; ?>">
        </div>
        <input type="submit" value="Update Categories" class="btn btn-info px-3 mb-3" name="edit_brand">
    </form>
</div>