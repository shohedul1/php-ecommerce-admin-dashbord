...
if(isset($_POST['user_update'])){
    ...
    //update query 
    $updata_data="update `user_table` set username='$user_username',user_email='$user_email',user_image='$user_image',user_address='$user_address',user_mobile='$user_mobile' where user_id='$update_id'";
