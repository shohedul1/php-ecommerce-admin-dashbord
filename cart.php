                ...
                <div class="row">
                    <form action="" method="post">
                        <table class="table table-bordered text-center">
                                    <!-- php code to distplay dynamic data -->
                                    <?php 
                                        // global $con;
                        ...
                        <div class="d-flex mb-5">
                            ...
                            if($result_count>0){
                                ...
                                <input type='submit' value='Continue Shopping' class='bg-info px-3 py-2 border-0 mx-3' name='countinue_shopping'>
            ...
            function remove_cart_item(){
                ...
                if(isset($_POST['remove_cart'])){
                    foreach($_POST['removeitem'] as $remove_id){
                        ...
                        $nun_delete=mysqli_query($con,$delete_query);
                        if($nun_delete){
